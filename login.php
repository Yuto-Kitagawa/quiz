        ...
        <main class="d-flex">
            ...
            <section id="mainSection" class="col-12 col-sm-12 col-md-12 col-lg-9 main-section p-2">
                <div class="main-container bg-white mt-3 p-4 d-flex justify-content-center flex-column ">
                    <div class="">
                        <div class="display-6 lead text-center">
                            問題作成サイト
                        </div>
                        <div class="lead text-center mt-2 fs-6 lead">
                            自分だけのオリジナル問題集を作成できます。作った問題は編集・削除や、友達とのシェアもできます！(友達はアカウント作成不要)<br>
                        </div>
                        <div class=" col-12 col-sm-12 col-md-8 col-lg-6 mx-auto mt-4">
                            <div class="lead">
                                メールアドレス
                            </div>
                            <div class="">
                                <input type="text" id="user_mail" name="user_mail" class="form-control">
                                <small id="err" class="text-danger" hidden>有効なメールアドレスを入力してください。</small>
                                <div id="cognit" class="text-success lead" hidden>入力したメールアドレスに認証用URLを送信しました。<br>同じ端末でメールを確認して下さい。</div>
                            </div>

                            <div class="mt-3 text-center">
                                <button class="btn btn-outline-success col-12" id="submit">ログイン(登録)</button>
                            </div>
                            <div class="small fs-6 lead mt-3 pb-5 fs-6 lead">※登録の際のみ、シークレットモードをオフにしてください。(ログイン時はシークレットモードでOK!)</div>
                        </div>
                    </div>
                </div>
            </section>
                ...
                if (!mail.match(/.+@.+\..+/)) {
                    ...
                    xhr.onload = (e) => {
                        ...
                        if (res == "True") {
                            ...
                            document.getElementById('cognit').hidden = false;
                        } else {
                            document.getElementById('err').hidden = false;
                        }
                    }
